...
Organizacion de branch: La carpeta Examen contiene un Examen.png, la cual es una screenshot de el circuito. examen_1_2026.ino es el codigo de dicho circuito
